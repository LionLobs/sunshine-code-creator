...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <header className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "bg-background/80 backdrop-blur-xl border-b border-border" : ""}`}>
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          <a href="#top" className="flex items-center gap-3">
            <img src={logo} alt="Elite Voleibol" className="h-10 w-auto drop-shadow-[0_0_18px_oklch(0.7_0.2_300_/_0.6)]" />
      ...
      {/* HERO */}
      <section id="top" className="relative min-h-[88vh] flex items-center pt-20 pb-10">
        ...
        <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-[1.1fr_1fr] gap-12 items-center relative">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl xl:text-6xl font-black leading-[0.9] tracking-tight">
              ELITE FLORIPA
              <br />
            ...
            <div className="mt-14 flex sm:grid sm:grid-cols-4 gap-4 sm:gap-6 overflow-x-auto no-scrollbar snap-x snap-mandatory -mx-6 px-6 sm:mx-0 sm:px-0 sm:overflow-visible">
              {pillars.map(({ icon: Icon, label }) => (
                <div key={label} className="snap-start shrink-0 w-[42%] sm:w-auto flex flex-col items-start gap-2 group">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary/30 to-accent/20 border border-primary/40 group-hover:scale-110 transition-transform shadow-[0_8px_20px_-8px_oklch(0.5_0.2_300_/_0.5)]">
        ...
        <div className="absolute bottom-6 right-8 text-5xl md:text-7xl font-black text-foreground/5 tracking-tighter select-none">01</div>
      </section>

      {/* STATS BAND */}
      <section className="relative py-10 border-y border-border bg-gradient-to-r from-card/50 via-background to-card/50 backdrop-blur">
      ...
      {/* WHY SPONSOR */}
      <section id="porque" className="relative py-16 md:py-20">
        <div className="absolute inset-0 -z-10">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 overflow-x-auto no-scrollbar snap-x snap-mandatory -mx-6 px-6 md:mx-0 md:px-0 md:overflow-visible">
            {reasons.map(({ icon: Icon, title, desc }, i) => (
              <div key={title} className="snap-start shrink-0 w-[85%] sm:w-[60%] md:w-auto group relative rounded-2xl border border-border bg-card/60 backdrop-blur p-5 hover:border-primary/60 hover:bg-card hover:-translate-y-1 transition-all overflow-hidden">
          ...
          <div className="mt-14 relative rounded-3xl border border-primary/40 bg-gradient-to-r from-primary/25 via-accent/10 to-primary/25 backdrop-blur p-6 md:p-8 overflow-hidden shadow-[var(--shadow-glow)]">
            ...
            <div className="relative flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="text-center md:text-left text-base md:text-xl font-black leading-snug">
      ...
      <section id="galeria" className="relative py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-5">
            <div className="col-span-12 md:col-span-8 relative rounded-3xl overflow-hidden h-[260px] md:h-[360px] group border border-border shadow-[var(--shadow-card)]">
            ...
            <div className="col-span-12 md:col-span-4 relative rounded-3xl overflow-hidden h-[260px] md:h-[360px] group border border-border shadow-[var(--shadow-card)]">
            ...
            <div className="col-span-6 md:col-span-4 relative rounded-3xl overflow-hidden h-[220px] group border border-border shadow-[var(--shadow-card)]">
            ...
            <div className="col-span-12 md:col-span-4 relative rounded-3xl overflow-hidden h-[220px] group border border-primary/40 bg-gradient-to-br from-primary/30 via-card to-accent/20 shadow-[var(--shadow-glow)] flex flex-col items-center justify-center p-6 text-center">
              <img src={logo} alt="Elite Voleibol" className="h-14 w-auto mx-auto drop-shadow-[0_0_25px_oklch(0.7_0.2_300_/_0.7)]" />
      ...
      {/* PLANS */}
      <section id="planos" className="relative py-16 md:py-20">
        <div className="absolute inset-0 -z-10">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 flex lg:grid lg:grid-cols-3 gap-6 overflow-x-auto no-scrollbar snap-x snap-mandatory -mx-6 px-6 pb-4 lg:pb-0 lg:mx-0 lg:px-0 lg:overflow-visible">
            {plans.map((plan) => (
              <div
                key={plan.tier}
                className={`snap-start shrink-0 w-[88%] sm:w-[70%] lg:w-auto relative rounded-3xl border bg-card/70 backdrop-blur-xl p-6 transition-all hover:-translate-y-2 group ${
                  plan.featured
              ...
              >
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-2xl font-black tracking-tight">{plan.tier.toUpperCase()}</div>
                      <div className="text-[11px] text-accent font-semibold mt-0.5">{plan.tagline}</div>
                    </div>
                  </div>
                  <div className="text-4xl font-black text-foreground/10 tracking-tighter">{plan.number}</div>
                </div>
                ...
                <div className="mt-8 rounded-2xl bg-background/60 border border-border px-5 py-4 backdrop-blur">
                  ...
                  <div className="mt-1 flex items-baseline gap-1">
                    ...
                    <span className="text-4xl font-black bg-gradient-to-br from-primary-foreground to-accent bg-clip-text text-transparent">{plan.price}</span>
      ...
      <section id="contato" className="relative py-16 md:py-20">
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="relative rounded-[2rem] border border-primary/40 bg-gradient-to-br from-card via-background to-card backdrop-blur-xl p-6 md:p-10 overflow-hidden shadow-[var(--shadow-glow)]">
            ...
            <div className="relative text-center">
              <img src={logo} alt="Elite Voleibol" className="mx-auto h-20 w-auto drop-shadow-[0_0_40px_oklch(0.7_0.2_300_/_0.8)]" />
              ...
              <div className="mt-10 inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-primary to-accent px-7 py-3.5 text-sm md:text-base font-bold text-primary-foreground shadow-[var(--shadow-glow)]">
